...
public class DrawFillOval extends DrawObject{
	...
	public DrawFillOval(Screen screen) {
...
*/
	...
	public void mouseReleased(MouseEvent e) {
		...
		Screen.bufferGraphics.fillOval(startPoint.x, startPoint.y, endPoint.x-startPoint.x, endPoint.y-startPoint.y);
		getScreen().repaint();
