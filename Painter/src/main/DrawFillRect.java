...
public class DrawFillRect extends DrawObject{
	...
	public DrawFillRect(Screen screen) {
...
*/
	...
	public void mouseDragged(MouseEvent e) {
		...
		g.fillRect(startPoint.x, startPoint.y, oldEndPoint.x-startPoint.x, oldEndPoint.y-startPoint.y);
	...
	public void mouseReleased(MouseEvent e) {
		...
		Screen.bufferGraphics.fillRect(startPoint.x, startPoint.y, endPoint.x-startPoint.x, endPoint.y-startPoint.y);
		getScreen().repaint();
	}
/*
	@Override
