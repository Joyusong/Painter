...
*/
	...
	public void mouseDragged(MouseEvent e) {
		...
		g.drawRoundRect(startPoint.x, startPoint.y, oldEndPoint.x-startPoint.x, oldEndPoint.y-startPoint.y,30,30);
		g.drawRoundRect(startPoint.x, startPoint.y, endPoint.x-startPoint.x, endPoint.y-startPoint.y,30,30);
	...
	public void mouseReleased(MouseEvent e) {
		...
		Screen.bufferGraphics.drawRoundRect(startPoint.x, startPoint.y, endPoint.x-startPoint.x, endPoint.y-startPoint.y, 30, 30);
		getScreen().repaint();
	}
/*
	@Override
