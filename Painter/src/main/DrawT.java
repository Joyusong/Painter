...
public class DrawT extends DrawObject{
	...
	/*	int count = startPointList.size();
		for(int i=0; i < count; i++) {
			...
			g.drawPolygon(TPointx,TPointy,3);
...
*/
	...
	public void mouseDragged(MouseEvent e) {
		...
		g.drawPolygon(oldTPointx,oldTPointy,3);
		g.drawPolygon(TPointx,TPointy,3);
	...
	public void mouseReleased(MouseEvent e) {
		...
		Screen.bufferGraphics.drawPolygon(TPointx,TPointy,3);
		getScreen().repaint();
